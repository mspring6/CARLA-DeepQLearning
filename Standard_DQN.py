...
class DQNAgent:
    ...
    def create_model(self):
        ...
        predictions = Dense(9, activation="linear")(x)  ## output layer include three nuros, representing three actions
        model = Model(inputs=base_model.input, outputs=predictions)
        model.compile(loss="mse", optimizer=Adam(learning_rate=0.00001), metrics=["accuracy"])          
