...
MODEL_PATH = 'models/Improved_DQNmodel_V2'
    ...
    def step(self, action):
        ...
        for i in range(2, len(self.filtered_waypoints)):
            ...
            if len(self.collision_hist) != 0:
                ...
                reward = -50
            elif carla.Location.distance(carla.Actor.get_location(self.actor_list[0]), self.filtered_waypoints[1].transform.location) == 5:
                done = False
                reward = 1
            elif carla.Location.distance(carla.Actor.get_location(self.actor_list[0]), self.filtered_waypoints[1].transform.location) == 10:
                done = False
                reward = 5
            elif carla.Location.distance(carla.Actor.get_location(self.actor_list[0]), self.filtered_waypoints[1].transform.location) == 20:
                done = False
                reward = 20
            elif carla.Location.distance(carla.Actor.get_location(self.actor_list[0]), self.filtered_waypoints[1].transform.location) == 30:
                done = False
                reward = 30
            elif carla.Location.distance(carla.Actor.get_location(self.actor_list[0]), self.filtered_waypoints[1].transform.location) == 40:
                done = False
                reward = 30
            elif carla.Location.distance(carla.Actor.get_location(self.actor_list[0]), self.filtered_waypoints[1].transform.location) == 50:
                done = False
                reward = 30
            else:
                done = False
...
class ModifiedTensorBoard(TensorBoard):
    ...
    def __init__(self, **kwargs):
        ...
        self.writer = tf.summary.create_file_writer('ImprovedDQNV3-log')
